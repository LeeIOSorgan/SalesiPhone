...
#define WY_NEWS_SHOW_ADS_VIEW_NOTIFICATION @"WY_NEWS_SHOW_ADS_VIEW_NOTIFICATION"
#define WY_NEWS_STOP_ADS_VIEW_NOTIFICATION @"WY_NEWS_STOP_ADS_VIEW_NOTIFICATION"
#define WY_THEME_SHOW_ADS_VIEW_NOTIFICATION @"WY_THEME_SHOW_ADS_VIEW_NOTIFICATION"
#define WY_THEME_STOP_ADS_VIEW_NOTIFICATION @"WY_THEME_STOP_ADS_VIEW_NOTIFICATION"
