...
//    [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleLightContent];
    ...
    for (UIView *subview in [self.view subviews]) {
        if ([self.titleNavBar isEqual:subview]) {
            ...
            [SPUIUtils updateFrameWithView:subview superView:self.view isAddHeight:YES];
        }else{
            BOOL isChange = [SPUIUtils updateFrameWithView:subview superView:self.view isAddHeight:NO];
