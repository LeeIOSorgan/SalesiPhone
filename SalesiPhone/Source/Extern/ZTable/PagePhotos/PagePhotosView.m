...
- (void)loadScrollViewWithPage:(int)page {
    ...
    ZImageView *view = [imageViews objectAtIndex:page];
    if ((NSNull *)view == [NSNull null]) {
		//UIImage *image = [dataSource imageAtIndex:page];
        //view = [[ZImageView alloc] initWithImage:image];
        NSString* strUrl = [dataSource imageUrlAtIndex:page];
        CGRect frame = self.frame;
        frame.origin.x = 0;
        frame.origin.y = 0;
        view = [[ZImageView alloc] initWithFrame:frame];
        [view setUrl:strUrl];
